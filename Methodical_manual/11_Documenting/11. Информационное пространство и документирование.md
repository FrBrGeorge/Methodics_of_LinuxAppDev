...
Также мы хотим, чтобы нами генерируемая документация сохранялась при установке проекта извне. Поэтому соответствующий рецепт указываем в `Makefile.am`
...
Теперь добавим генерацию других документов, например, [`man`](https://man7.org/linux/man-pages/man1/man.1.html) — _руководство_.
...
```console
stephen@localhost:~/LinuxAppDev/11_Documenting/Lection/namegen> man ./doxygen-doc/man/man1/namegen.c.1 
